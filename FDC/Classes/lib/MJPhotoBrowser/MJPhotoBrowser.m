...
- (void)show
{
    titleLabel=[[UILabel alloc]initWithFrame:CGRectMake(0,20, [UIScreen mainScreen].bounds.size.width, 40)];
...
- (void)updateTollbarState
{
    ...
    _toolbar.currentPhotoIndex = _currentPhotoIndex;
    titleLabel.text=[self.imageTitles objectAtIndex:_currentPhotoIndex];
}
