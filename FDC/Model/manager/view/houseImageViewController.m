...
-(void)loadImage{
    ...
    for (int i=0; i<self.images.count; i++) {
        ...
        NSOperation* op=[NSBlockOperation blockOperationWithBlock:^{
            ...
            NSString* url=[NSString stringWithFormat:@"http://%@/HWT.WEB%@",LoginProjectName,[dic objectForKey:@"HX_IMG"]];
...
//                    [self tapImage:nil];
      ...
      [Utils hiddenLoading];
    self.scrollView.contentSize=CGSizeMake(0, (self.images.count/2+1)*(imageWidth+10));
}
