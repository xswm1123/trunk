...
-(void) queryCustomerWithObjectId:(NSString*) objectId UserId:(NSString*) userId customerName:(NSString*) customerName customerPhone:(NSString*) customerPhone certificate:(NSString*) certificate visitDate:(NSString*) visitDate endDate:(NSString*) endDate visitWay:(NSString*) visitWay orderLevel:(NSString*) orderLevel  tradeState:(NSString*) tradeState success:(CallBackHttpUtilRequest) success faild:(CallBackHttpUtilRequest) faild{
    ...
    [params setObject:@"" forKey:@"KH_LFRQ_BEGIN"];
    [params setObject:@"" forKey:@"KH_LFRQ_END"];
    ...
    if ([NSString isEnabled:visitDate]) {
        [params setObject:visitDate forKey:@"KH_LFRQ_BEGIN"];
    }
    if ([NSString isEnabled:endDate]) {
        [params setObject:endDate forKey:@"KH_LFRQ_END"];
    }
