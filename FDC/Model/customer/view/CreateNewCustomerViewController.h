...
@property (weak, nonatomic) IBOutlet UIButton *add_nameBtn;
@property (weak, nonatomic) IBOutlet UIButton *add_numberBtn;
@property (weak, nonatomic) IBOutlet UIButton *add_idBtn;
@property (weak, nonatomic) IBOutlet UIButton *sexBtn;
@property (weak, nonatomic) IBOutlet UIButton *callTypeBtn;
@property (weak, nonatomic) IBOutlet UIButton *customerTypeBtn;
@property (weak, nonatomic) IBOutlet UIButton *customerLevelBtn;
@property (weak, nonatomic) IBOutlet UIButton *mindBtn;
