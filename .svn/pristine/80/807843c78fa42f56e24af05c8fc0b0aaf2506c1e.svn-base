...
@property (weak, nonatomic) IBOutlet UILabel *countPerMonth;
@property (weak, nonatomic) IBOutlet UILabel *countFirstMonth;
...
-(void)createData{
    ...
    self.countPerMonth.text=[self.calculateInfos objectForKey:@"YJHKE"];
    self.countFirstMonth.text=[self.calculateInfos objectForKey:@"SYHKE"];
