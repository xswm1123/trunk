//
//  VerifyIDCardNumberManagerTool.m
//  FDC
//
...
@implementation VerifyIDCardNumberManagerTool
...
//    value = [value stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
//    if ([VerifyIDCardNumberManagerTool verifyText:value withRegex:s1]) {
//        NSString *s11 = @"^\\d{4,20}$";
...
{
    NSString *birtday = [VerifyIDCardNumberManagerTool getIDCardBirthday:card];   //****年**月**日
    //转换为****-**-**
...
//    NSDate *dateBirtday = [date dateFromString:birtday];
